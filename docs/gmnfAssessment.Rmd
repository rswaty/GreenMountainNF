...
```{r historical fire, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=10 }

bpsMFRI10 <- read_csv("OUTPUTS/bps_aoi_attributes.csv") %>%
   slice(-c(7, 24)) %>%
...
# read in snkyPdata
snkyPdata <- read_csv("DATA/sncEvtSankey.csv")
